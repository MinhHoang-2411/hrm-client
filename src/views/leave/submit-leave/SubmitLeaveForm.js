                    ...
                    <Grid container spacing={gridSpacing}>
                        ...
                        <Grid item lg={4} md={4} sm={4} xs={4}>
                            ...
                            >
                                <Box>
                                    <div>
                                        <p style={{ fontSize: '16px', paddingTop: '5px', fontWeight: 'bold' }}>Leave Detail</p>
                                        <p style={{ fontWeight: 'bold' }}>{infor.leaveUnUse} days of Annual Leave</p>
                                    </div>
                                    <ul style={{ paddingLeft: 0 }}>
                                        {weekendFilter(dateAndLeaveTimes).map((item, index) => {
                                            return (
                                                <div key={index}>
